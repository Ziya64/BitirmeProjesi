...
import com.example.apina.databinding.FragmentAnasayfaBinding;
import com.example.apina.ui.adapter.YemekAdapter;
...
public class AnasayfaFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.setAnasayfaToolbarBaslik("Apina");
        ((AppCompatActivity)getActivity()).setSupportActionBar(binding.toolbarAnasayfa);


        viewModel.yemekListesi.observe(getViewLifecycleOwner(),yemeks -> {
            YemekAdapter adapter = new YemekAdapter(requireContext(),yemeks,viewModel);
            binding.setYemekAdapter(adapter);
